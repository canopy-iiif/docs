...
# Building a Canopy Collection Using Tropy and Tropiiify
...
<Section size="1">
  <Text size="4">
    ...
    or a IIIF Image server.  This guide will walk you through the process of starting from zero and building a
    Canopy site around [Tropy](https://tropy.org/), [Tropiiify](https://github.com/arkalab/tropiiify), and
    GitHub Pages to serve IIIF images.
  </Text>
</Section>
...
<Callout type="info">
    ...
    All of these additional requirements are free for you to use.
</Callout>

## Use Case

  You are a digital scholar with many of images on your personal computer that are not available in an existing IIIF
  repository online, and you would like to build a new digital scholarship site that uses your materials.
...
* Give your repository a name that makes sense for your project. (i.e. *images-for-canopy-project*)
...
### Export Your Images and Works to IIIF
...
1. Follow the instructions in [this guide](https://canopy-iiif.github.io/docs/deploy-to-github-pages) to set up a new Canopy site in GitHub Pages.
2. In your `config/canopy.json`file in your new Canopy instance, set the `collection` value to `https://{GitHubAccount}.github.io/{RepositoryYouCreatedInStep1}/index.json`
3. Your site should now build. Once it's done, your Canopy site should exist with your content.
