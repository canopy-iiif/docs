...
<Callout>
  The Map component is populated by Manifests with a `navPlace` property. For more information, see the [IIIF `navPlace` extension](https://iiif.io/api/extension/navplace/) specification.
</Callout>
...
<Steps>
  ...
  1. In accordance with the [specification](https://iiif.io/api/extension/navplace/#31-linked-data-context), include the `navPlace` extension to the Linked Data Context of each manifest by adding
  ...
  ```json copy filename="content/_meta.json" {5}
[
  {
    "path": "/works",
    "text": "Works"
