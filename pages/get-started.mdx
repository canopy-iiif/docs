...
Copy the example configuration file and update the `prod` and `dev` values with your IIIF Collection URL. See [Configuration](/configuration) for detailed documentation.
