...
### Reference Items in your Collection
...
Your page should now output a grid of items that are referenced by the current page. This connection is now made between the scholarly content and the items in the IIIF Collection. From the `/work` page, you can now navigate to and from the scholarly content page reciprocally.
