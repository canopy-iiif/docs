...
Canopy IIIF is a highly configurable application that can be tailored to the needs of a project. Most Canopy configurations fallback to default options if not customized.
