...
<Grid columns={{ initial: "1", md: "2" }} gap="6" width="auto">
  ...
  <GridItem
    title="abolition now."
    description="Documenting an unprecedented flow of social movement art in the era of new abolition. This project is directly sourced from material hosted in the [Abolition Now: Images for study and struggle](https://archive.org/details/abolition-now-images) collection hosted in the Internet Archive."
    href="https://abolitionimages.org/"
    hrefCode="https://github.com/abolition-now/an"
    imgSrc="https://iiif.archive.org/image/iiif/3/an_0039_yourepartoftheworld%2F0039_yourepartoftheworld_oo.jpg/0,650,1000,1000/600,/0/default.jpg"
  />
  <GridItem
